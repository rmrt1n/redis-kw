...
void test_hash_funcs() {
    ...
    test_case("test hash functions", {
        ...
        // hget
        expect("hash a:1 = '2'", strcmp(htable_hget(ht, "a", "1"), "2") == 0);
        expect("hash a:2 = '3'", strcmp(htable_hget(ht, "a", "2"), "3") == 0);
        expect("hash a:3 = '4'", strcmp(htable_hget(ht, "a", "3"), "4") == 0);
        expect("hash a:4 = '5'", strcmp(htable_hget(ht, "a", "4"), "5") == 0);
        expect("hash a:5 = NULL", htable_hget(ht, "a", "5") == NULL);
